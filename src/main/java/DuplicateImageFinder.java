...
public class DuplicateImageFinder {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        String folderPath = "C:\\Users\\gabri\\Documents\\Backup";
    ...
    private static void initializeFileLog() throws FileNotFoundException {
        File file = new File("C:\\Users\\gabri\\Documents\\log_duplicated.txt");
        ...
        for (File file : Objects.requireNonNull(folder.listFiles())) {
            if (file.isFile() && isImageFile(file)) {
                ...
                if (imageChecksums.containsKey(checksum)) {
                    ...
                    if (file.delete()) {
                        System.out.println("Foto/Vídeo deletado:" + file.getAbsolutePath());
                    }
                } else {
